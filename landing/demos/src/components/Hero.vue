...
<div class="relative bg-white overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-10 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:pl-8 lg:pr-4">
        <nav class="relative flex items-center justify-between sm:h-10" aria-label="Global">
          <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#">
                <span class="sr-only">Workflow</span>
                <img class="h-6 w-auto sm:h-7" src="http://www.cactusco.cl/static/img/imagotipo_cactus.png">
              </a>
      ...
      -->
      <div v-show="isHeaderVisible" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
