...
var productNameClicked = document.querySelector(".elementor-widget-container h1").innerText.toLowerCase();
createCookie("ClickRelatedProduct"+"_"+timestamp,productNameClicked,5)
/*
