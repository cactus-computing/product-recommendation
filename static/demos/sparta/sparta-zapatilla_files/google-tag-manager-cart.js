/**
 * Sobreescrito para que llame a Lyracons_GoogleTagManagerEnhanced/js/google-analytics-universal
 * en vez del script de Magento (no encontre manera de utilizar un mixin
 */
define([
    'jquery',
    'Magento_Customer/js/customer-data',
    'Lyracons_GoogleTagManagerEnhanced/js/google-analytics-universal',
    'Lyracons_GoogleTagManagerEnhanced/js/google-analytics-universal-cart',
    'underscore',
