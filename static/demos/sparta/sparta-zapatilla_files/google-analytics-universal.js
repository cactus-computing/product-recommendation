/**
 * Sobreescrito para que agregue mas informacion en los productImpression
 */
...
define([
    ...
    GoogleAnalyticsUniversal.prototype = {
         ...
         * Add to cart action
         *
         * Antes: addToCart: function (id, name, price, quantity) {
         *
         ...
         *
         * Antes: removeFromCart: function (id, name, price, quantity) {
         *
         * @param {Object} product
         */
